...
Effects are not implicit consequences of computation. They are **declared operations** that appear syntactically in a process body and are governed by regime-specific rules.
...
Observable outcomes from Q-regime computation MUST occur via binding to K-regime processes.
