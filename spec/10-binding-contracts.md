...
A DPL implementation MUST enforce all bindings and contracts statically where possible and semantically otherwise.
...
Bindings reference processes using:
- fully qualified paths (`K::run`), or
- unqualified identifiers resolved within the same forge.
...
A **contract** is a declarative set of clauses that constrain a binding.
...
- define admissibility requirements.
...
### 10.5.2 Standard Contract Attributes (v0.1)

The following attributes are standardized in v0.1:
...
Implementations MAY support additional attributes but MUST NOT reinterpret these.
...
- MUST preserve linearity,
- confines observation and effects to the K-regime.
...
- illegal witness transfer,
- unauthorized effects,
- regime boundary violations.

All failures are semantic and MUST be reported deterministically.
